...
TestObject( gfx,rng,adist,ddist,odist,rdist ) {
    ...
    {
        auto pvs = std::make_unique<VertexShader>( gfx,L"D:/Dev/C++/gaming/GameEngine/shader/_BlendedPhongVS.cso" );
        auto pvsbc = pvs->GetBytecode();
        AddStaticBind( std::move( pvs ) );

        AddStaticBind( std::make_unique<PixelShader>( gfx,L"D:/Dev/C++/gaming/GameEngine/shader/_BlendedPhongPS.cso" ) );
